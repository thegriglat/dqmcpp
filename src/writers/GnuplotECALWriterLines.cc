...
std::vector<std::array<int, 4>> EndcapLines() {
  ...
  // inner lines
  auto q = generateLines(
      {{{35, 3}, {35, 15}, {40, 15}, {40, 30}, {45, 30}, {45, 40}}}

  );
  std::copy(q.begin(), q.end(), std::back_inserter(r));

  q = generateLines({{{7, 25},
                      {10, 25},
                      {10, 30},
                      {20, 30},
                      {20, 35},
  ...
  q = generateLines(
      {{{50, 39}, {45, 39}, {45, 40}, {43, 40}, {43, 41}, {42, 41}, {42, 42},
        {41, 42}, {41, 43}, {40, 43}, {40, 45}, {39, 45}, {39, 55}, {40, 55},
        {40, 57}, {41, 57}, {41, 58}, {42, 58}, {42, 59}, {43, 59}, {43, 60},
        {45, 60}, {45, 61}, {50, 61}
